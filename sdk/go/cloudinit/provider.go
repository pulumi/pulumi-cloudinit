...
func NewProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumi:providers:cloudinit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (r *Provider) TerraformConfig(ctx *pulumi.Context) (ProviderTerraformConfigResultOutput, error) {
	out, err := ctx.Call("pulumi:providers:cloudinit/terraformConfig", nil, ProviderTerraformConfigResultOutput{}, r)
	if err != nil {
