...
public final class ConfigPartArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ConfigPartArgs() {}

    private ConfigPartArgs(ConfigPartArgs $) {
    ...
    public static Builder builder(ConfigPartArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ConfigPartArgs defaults) {
        ...
        public ConfigPartArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("ConfigPartArgs", "content");
            }
            return $;
        }
    }
